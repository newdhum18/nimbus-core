...
- `nimbus-core-v36-zero.sqlite`: clean local reference database with schema version 10 and the current autonomous source catalog. It contains no runs, links, candidates, credentials, or production data.
