# File Inventory — Nimbus Core V36.9.0
...
- `src/config.js` — 782 bytes
- `src/db/batch.js` — 1022 bytes
- `src/db/migration-catalog.js` — 961 bytes
...
- `src/queue/consumer.js` — 11228 bytes
...
- `src/queue/watchdog.js` — 695 bytes
...
- `src/sources/intelligence.js` — 2582 bytes
- `src/sources/metrics.js` — 3459 bytes
