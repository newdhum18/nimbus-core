const CACHE='nimbus-core-v22';
self.addEventListener('install',event=>{self.skipWaiting();event.waitUntil(caches.open(CACHE).then(c=>c.addAll(['/?v=22','/style.css?v=22','/app.js?v=22','/config.js?v=22','/manifest.json?v=22'])))});
