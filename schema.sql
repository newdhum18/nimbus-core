...
CREATE TABLE IF NOT EXISTS scan_state (id TEXT PRIMARY KEY, cursor INTEGER DEFAULT 0, updated_at TEXT DEFAULT CURRENT_TIMESTAMP);
CREATE INDEX IF NOT EXISTS idx_mega_last ON mega_links(last_seen_at DESC);
CREATE INDEX IF NOT EXISTS idx_mega_host ON mega_links(source_host);
