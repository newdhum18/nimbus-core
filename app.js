...
function bind() {
  ...
  $('exportJsonBtn').onclick = () => download('/api/export?format=json', 'nimbus-core-v21-export.json');
  $('exportCsvBtn').onclick = () => download('/api/export?format=csv', 'nimbus-core-v21-export.csv');
}
...
async function ping() {
  ...
  $('statVersion').textContent = d.version || 'V21';
...
async function clearCache() {
  try {
    ...
    $('settingsLog').textContent = 'Cache cleared. Reopen: /?v=21&fresh=1 or use /reset';
